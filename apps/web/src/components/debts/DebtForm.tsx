    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-1.5">
        ...
        <select
          ...
          className="h-11 w-full rounded-xl border border-white/60 bg-white/45 px-3 text-sm text-foreground backdrop-blur-xl dark:border-white/20 dark:bg-slate-900/35 dark:text-white"
        >
        ...
        {!lockContact && onQuickAddContact ? (
          <div className="rounded-xl border border-white/50 bg-white/35 p-2 backdrop-blur-xl dark:border-white/20 dark:bg-slate-900/30">
            <Button
              type="button"
              variant="outline"
            ...
            >
                ...
                <Input
                  ...
                  className="h-10 border-white/60 bg-white/55 dark:border-white/20 dark:bg-slate-900/45"
                />
                <Input
                  value={quickPhone}
